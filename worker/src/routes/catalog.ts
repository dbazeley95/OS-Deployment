 ...
 * OS profiles and apps directly (D1-backed, see worker/src/lib/profiles.ts
 * and worker/src/lib/apps.ts) instead of requiring a code change +
 * redeploy. Mounted at /api/catalog, behind the session middleware in
 * worker/src/index.ts.
 */
